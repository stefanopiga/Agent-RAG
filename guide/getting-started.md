...
**Inizia dai tutorial!** Consulta la cartella `docling_basics/` nella root del progetto per esempi progressivi che insegnano i fondamenti di Docling:
...
Questi tutorial forniscono le basi per comprendere come funziona questo agente RAG completo.
...
- **[Architecture](architecture.md)**: Complete system architecture, design decisions, and component descriptions
- **[Coding Standards](coding-standards.md)**: Code style guide, naming conventions, documentation standards, and best practices
- **[Testing Strategy](testing-strategy.md)**: TDD workflow, test organization, RAGAS evaluation, and CI/CD integration
- **[Development Guide](development-guide.md)**: Setup instructions, development workflow, and troubleshooting
- **[Documentation Index](index.md)**: Complete documentation index with quick links and navigation

### Quick Links

- **Code Style**: See [Coding Standards](coding-standards.md) for Python style guide, type hints, error handling patterns
- **Writing Tests**: See [Testing Strategy](testing-strategy.md) for TDD approach, test organization, coverage requirements
- **Project Structure**: See [Unified Project Structure](unified-project-structure.md) for directory organization, file placement rules, epic mapping
- **Architecture Patterns**: See [Architecture](architecture.md) for design decisions, integration patterns, observability
...
**Guida Completa:** Consulta [LangFuse Dashboard Guide](langfuse-dashboard-guide.md) per la configurazione dettagliata del dashboard.
